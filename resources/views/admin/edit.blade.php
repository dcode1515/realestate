                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"  class="form-control" value="{{$property->id}}" name="id" placeholder="Enter Property Name" hidden>
                                                    <input type="text"  class="form-control" value="{{$property->property_name}}" name="property_name" placeholder="Enter Property Name">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="project-overview" class="form-label">Property Address</label>
                                                    <textarea class="form-control"  id="project-overview" name="property_address" rows="5" placeholder="Enter Property Address">{{$property->property_address}}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="project-overview" class="form-label">Quality</label>
                                                    <input type="text"  value="{{$property->quality}}" name="quality" class="form-control" placeholder="Enter Property Quality">
                                                 
                                                </div>
                                                <div class="mb-3">
                                                    <label for="projectname" class="form-label">Square Meter</label>
                                                    <input type="text"  value="{{$property->square_meter}}" name="square_meter" class="form-control" placeholder="Enter Square meter">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="projectname" class="form-label">Bedrooms</label>
                                                    <input type="number"  value="{{$property->bedrooms}}" name="bedrooms" class="form-control" placeholder="Enter # of Bedrooms">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="projectname" class="form-label">Toilet</label>
                                                    <input type="number" value="{{$property->toilet}}" name="toilet"  class="form-control" placeholder="Enter # of Toilet">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="projectname" class="form-label">Price</label>
                                                    <input type="number" name="price" value="{{$property->price}}"  class="form-control" placeholder="Enter Price of the Property">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="projectname" class="form-label">Type</label>
                                                    <select class="form-control" value="{{$property->type}}" name="type">
