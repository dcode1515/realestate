                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                                                <a data-bs-toggle="modal" data-bs-target="#standard-modal" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Property Type</a>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable">
                                                ...
                                                <tbody>
                                                    @foreach($property_type as $key=>$data)
                                                    <tr>
                                                        ...
                                                        <td class="table-action">
                                                            <a data-bs-toggle="modal" data-bs-target="#standard-modal1{{$data->id}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <form action="{{ route('deleteType', ['id' => $data->id]) }}" method="POST" id="delete-form-{{ $data->id }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="action-icon delete-property" onclick="return confirm('Are you sure you want to delete this property type?');">
