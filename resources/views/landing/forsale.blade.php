...
<html lang="en">
  ...
  <body>
    ...
    <div class="img overlay" style="background-image: url('{{ asset('public/property/images/hero_bg_3.jpg') }}')"></div>
    <div class="img overlay" style="background-image: url('{{ asset('public/property/images/hero_bg_2.jpg') }}')"></div>
    <div class="img overlay" style="background-image: url('{{ asset('public/property/images/hero_bg_1.jpg') }}')"></div>
            </div>
          ...
          <div class="col-12">
            <div class="property-slider-wrap">
              <div class="property-slider">
                @foreach($for_sale as $data)
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="{{ asset('public/attachment/Property/'. $data->property_no.'/'.$data->image1) }}" alt="Image" class="img-fluid" />
                  </a>

                  <div class="property-content">
                    <div class="price mb-2"><span>Price: {{$data->price}}</span></div>
                    <div>
                      <span class="d-block mb-2 text-black-50"
                        >{{$data->property_address}}</span
                      >
                      <span class="city d-block mb-3">{{$data->property_name}}</span>

                      <div class="specs d-flex mb-4">
                        <span class="d-block d-flex align-items-center me-3">
                          <span class="icon-bed me-2"></span>
                          <span class="caption">{{$data->bedrooms}} bedrooms</span>
                        </span>
                        <span class="d-block d-flex align-items-center">
                          <span class="icon-bath me-2"></span>
                          <span class="caption">{{$data->toilet}} toilets</span>
                        </span>
                      </div>

                      <a
                        href="{{ route('property.view', ['id' => $data->id]) }}"
