...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">Prime<span class="color-b">Property</span></a>
        ...
        <option value="{{ route('forrent') }}">For Rent</option>
          ...
          <div class="col-md-4">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
              <img src="{{ asset('public/attachment/Property/' . $index->property_no.'/'.$index->image1) }}" alt="" class="img-a img-fluid">
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          -->
            Designed by <a href="https://bootstrapmade.com/">Prime Property</a>
          </div>
        </div>
      </div>
    </div>
